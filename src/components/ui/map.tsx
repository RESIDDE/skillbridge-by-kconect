...
export function WorldMap({ 
  dots = [], 
  lineColor = "rgba(191, 128, 255, 0.8)",
  showLabels = true,
  ...
  const svgMap = useMemo(
    () => map.getSVG({
      radius: 0.22,
      color: theme === "dark" ? "#BF80FF25" : "#00000040",
      shape: "circle",
  ...
  return (
    <div className="w-full h-full dark:bg-black bg-transparent rounded-lg relative font-sans overflow-hidden">
      <img
      ...
      >
        <defs>
          <linearGradient id="path-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <stop offset="10%" stopColor="rgba(191,128,255,0.7)" stopOpacity="1" />
            <stop offset="50%" stopColor="rgba(220,190,255,0.95)" stopOpacity="1" />
            <stop offset="90%" stopColor="rgba(191,128,255,0.7)" stopOpacity="1" />
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center justify-center h-full">
                        <span style={{fontSize:'7px', fontWeight:600, color:'rgba(255,255,255,0.7)', letterSpacing:'0.04em', whiteSpace:'nowrap'}}>
                          {dot.start.label}
                        </span>
                      </div>
                    </foreignObject>
